...
SECRET_KEY = '7pxt96nt-nvgbnw3_jb(#bwgkkanjlbsbmr@7xpak#t71n@63&'
...
with open("shareclass/oauth_credentials.json") as foauth:
...
with open("shareclass/aws_credentials.json") as f:
